...
exports.routes = function(route) {
  route.get("/search", function*() {
    if (_.isUndefined(this.query.q)) {
      this.body = yield render("search", { title: "Search", has_query: false });
    } else {
      ...
      var where_clause = { first_name: firstName };

      if (!_.isEmpty(lastName)) {
        _.extend(where_clause, { last_name: lastName });
      }

      var athletes = yield new Athletes()
