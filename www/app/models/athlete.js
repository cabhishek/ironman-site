...
var Athlete = Backbone.RelationalModel.extend({
  ...
  validation: {
    first_name: { required: true, msg: "Required" },
    last_name: { required: true, msg: "Required" },
    email: { required: true, pattern: "email", msg: "Required" }
  },
  ...
  relations: [
    { type: Backbone.HasMany, key: "races", relatedModel: AthleteRace }
  ]
});
